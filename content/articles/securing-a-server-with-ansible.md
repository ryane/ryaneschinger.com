...
<div class="note" markdown="1">
***Note**: If you are brand new to ansible, you might want to check out my [quick start post](/blog/ansible-quick-start/) and the [ansible documentation](http://docs.ansible.com/).*
</div>
...
<!--     <strong>Are you looking for a devops partner for your business?</strong> -->
<!--     <p> -->
<!--     You are ready for the next level and want to establish a competitive advantage for your business by adopting practices like automated infrastructure and continuous delivery. Please <a href="mailto:ryan@ryaneschinger.com?subject=Devops Partner">contact me</a> to see how I can help you. -->
<!--     </p> -->
<!--     </div> -->
<!--   </div> -->
<!-- </div> -->
